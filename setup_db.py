...
SEED_PARAMETERS = [
    ...
    ("weather", "heat_haze",            "air shimmer from baked ground, bleached sky, intense heat, dust rising from every footfall",                        1.0, "terrestrial"),
    ("weather", "hot_still_air",        "oppressive dead still heat, no wind, everything motionless, heavy atmosphere",                                1.0, "terrestrial"),
    ...
    ("weather", "rain_clearing",        "wet surfaces catching first sun, last drops falling, clouds breaking, steam rising",                         1.0, "terrestrial"),
    ...
    ("weather", "arctic_freeze",        "frost on scales and breath condensation heavy, ice at eyelid edges, blue-white light, extreme cold",                  1.0, "terrestrial"),
    ...
    ("weather", "late_afternoon_cool",  "shadows lengthening in cooling air, temperature dropping, calm before dusk",                                   1.0, "terrestrial"),
    ("weather", "post_storm_clearing",  "shafts of sunlight breaking through broken cloud, glistening surfaces, steam rising from ground",                     1.0, "terrestrial"),
    # Terrestrial beauty / dramatic atmosphere
    ("weather", "crepuscular_rays",    "sunlight shafts breaking through massing clouds, gold-edged crepuscular rays fanning across sky, warm amber light pooling on ground",  1.0, "terrestrial"),
    ("weather", "rainbow_after_storm", "vivid rainbow arching over landscape, wet ground still steaming, last clouds breaking to low sun, every surface glistening",           1.0, "terrestrial"),
    ("weather", "blue_hour_still",     "deep twilight blue-hour, saturated cobalt sky fading to indigo at zenith, no wind, cool blue light washing landscape",                 1.0, "terrestrial"),
    ("weather", "golden_haze",         "warm golden afternoon haze, amber light saturating atmosphere, long raking shadows, rich warm tones on every surface",                 1.0, "terrestrial"),
    ("weather", "crystal_morning",     "knife-sharp crystal morning air, deep saturated blue sky, long shadows, no humidity",                        1.0, "terrestrial"),
    ("weather", "stormy_backlight",    "dark blue-black storm wall behind, single shaft of warm golden light cutting through, dramatic chiaroscuro, lit edge on animal",       1.0, "terrestrial"),
    # Marine — 20
